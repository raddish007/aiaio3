...
export default function DemoLoreleiPage() {
  ...
  const fetchLoreleiVideos = async () => {
    try {
      setLoading(true);
      // Get Lorelei's playlist from child_playlists table
      const { data: playlistData, error: playlistError } = await supabase
        .from('child_playlists')
        .select('videos, updated_at')
        .eq('child_id', '6a248ddf-fdf0-4645-9a80-e82bf7672d70')
        .single();
      ...
      console.error('Error fetching Lorelei videos:', err);
  ...
  return (
    <>
      <Head>
        <title>Lorelei's Learning Videos - Demo</title>
        <meta name="description" content="Personalized learning videos for Lorelei" />
      </Head>
      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8 flex items-center space-x-4">
            ...
            />
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Lorelei</h2>
              <p className="text-gray-600 text-lg">
                Watch Lorelei's custom videos designed to help with letter recognition, name learning, and early literacy skills.
              </p>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg">No videos available for Lorelei yet.</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {videos.map((video) => (
                <div 
                  ...
                  onClick={() => router.push({
                    ...
                    query: { videoId: video.id, childId: '6a248ddf-fdf0-4645-9a80-e82bf7672d70' }
                  })}
                >
