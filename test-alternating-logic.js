...
async function testAlternatingLogic() {
  console.log('🦕 Testing alternating logic for dinosaur theme...\n');

  try {
    const theme = 'dinosaur';
    const name = 'CHRISTOPHER'; // 11 letters
    
    console.log(`Testing with name: ${name} (${name.length} letters)`);
    console.log(`Theme: ${theme}\n`);

    // Get dinosaur theme images
